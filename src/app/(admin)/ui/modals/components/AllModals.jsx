...
const ModalSizes = () => {
  ...
  return <ComponentContainerCard title="Bootstrap Modals" description={<p className="text-muted mb-0">A rendered modal with header, body, and set of actions in the footer.</p>}>
...
const ModalsWithPages = () => {
  ...
  return <ComponentContainerCard title="Modal with Pages" description={<p className="text-muted mb-0">Examples of custom modals.</p>}>
      <div className="d-flex flex-wrap gap-2">
...
const ModalWithAlerts = () => {
  ...
  return <ComponentContainerCard title="Modal based Alerts" description={<p className="text-muted mb-0">Show different contexual alert messages using modal component</p>}>
      <div className="d-flex flex-wrap gap-2">
...
const ModalPositions = () => {
  ...
  return <ComponentContainerCard title="Modal Position" description={<p className="text-muted mb-0">
...
const ModalWithColoredHeader = () => {
  ...
  return <ComponentContainerCard title="Colored Header Modals" description={<p className="text-muted mb-0">A rendered modal with header having contexual background color.</p>}>
...
const ModalWithFilled = () => {
  ...
  return <ComponentContainerCard title="Filled Modals" description={<p className="text-muted mb-0">A rendered modal with header, body and footer having contexual background color.</p>}>
...
const MultipleModal = () => {
  ...
  return <ComponentContainerCard title="Multiple Modal" description={<p className="text-muted mb-0">Display a series of modals one by one to guide your users on multiple aspects or take step wise input.</p>}>
...
const ToggleBetweenModals = () => {
  ...
  return <ComponentContainerCard title="Toggle Between Modals" description={<p className="text-muted mb-0">
...
const FullscreenModal = () => {
  ...
  return <ComponentContainerCard title="Fullscreen Modal" description={<p className="text-muted mb-0">
...
const StaticBackdropModal = () => {
  ...
  return <ComponentContainerCard title="Static Backdrop" description={<p className="text-muted mb-0">
...
const VaryingModalContent = () => {
  ...
  return <ComponentContainerCard title="Varying Modal Content" description={<p className="text-muted mb-0">
